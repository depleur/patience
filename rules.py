...
class RulesManager:
    def __init__(self, master):
        ...
        self.fullscreen = tk.BooleanVar(value=False)  # Add this line
...
Good luck and enjoy the game!"""
    ...
    def load_preferences(self):
        try:
            with open("patience_preferences.json", "r") as f:
                ...
                self.fullscreen.set(prefs.get("fullscreen", False))  # Add this line
    ...
    def save_preferences(self):
        prefs = {
            ...
            "fullscreen": self.fullscreen.get(),  # Add this line
        }
